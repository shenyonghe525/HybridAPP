package com.syh.test.hybridapp;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myWebView.addJavascriptInterface(new WebAppInterface(), "demo");
	...
	public class WebAppInterface {
		// 4.2后必须在共有接口中加注解 target > 17
		@JavascriptInterface
		public void runOnAndroidJavaScript(final String toast) {
			Toast.makeText(getBaseContext(), toast, Toast.LENGTH_LONG).show();
			myTextView = (TextView) findViewById(R.id.textView);
			myTextView.setText(toast);
		}
	}
